package io.github.marcelbraghetto.football.framework.providers.sharedpreferences.contracts;
...
public interface SharedPreferencesProvider {
    ...
    /**
     * Save the given long value to shared preferences.
     * @param key to save the value for.
     * @param value to save.
     */
    void saveLong(@NonNull String key, long value);

    /**
     * Retrieve the given long with the given key from
     * the shared preferences.
     * @param key to retrieve.
     * @param defaultValue to return if the key wasn't found.
     * @return the saved value or default value if not found.
     */
